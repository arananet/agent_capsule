...
All notable changes to `browser-agent-poc` will be documented in this file.
...
[Unreleased]: https://github.com/arananet/browser-agent-poc/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/arananet/browser-agent-poc/releases/tag/v0.1.0
